...
var Pagination = {
    ...
    Extend: function(data) {
        ...
        Pagination.offset = data.offset || 1;
        Pagination.limit = data.limit || 10;
    },

    // add pages by number (from [s] to [f])
    Add: function(s, f) {
        for (let i = s; i < f; i++) {
            let url =  Pagination.url + "?offset=" + (i-1)*Pagination.limit + "&limit=" + Pagination.limit;
            Pagination.code += `<a href="${url}">${i}</a>`;
